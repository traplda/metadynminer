...
#' by Torrie and Valleau, J. Comput. Phys. (1977) <doi.org/10.1016/0021-9991(77)90121-8>
#'
#' `reweighttv` calculates free energy surface from colvars by
#' Torrie and Valleau algorithm. It should be used for a biased simulation with a static
#' bias potential. For metadynamics it is better to use 'reweighttiwary'.
#'
#' @param cvfile colvarfile object.
#' @param temp temperature in Kelvins
#' @param eunit energy units (kJ/mol or kcal/mol, kJ/mol is default)
